...
package com.fred.QrScan.camera;
...
//      }
    ...
    public Rect getFramingRect() {
        try {
            ...
            Log.d(CameraConfigurationManager.class.getSimpleName(), "getFramingRect(): " + framingRect);
            return framingRect;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
...
//        }
//        Log.d(CameraConfigurationManager.class.getSimpleName(), "getFramingRectInPreview(): " + framingRectInPreview);
   ...
   */
     ...
     * @param isEnable
     */
    public void setLightOn(boolean isEnable) {
        if (camera != null) {
            Camera.Parameters parameter = camera.getParameters();
            parameter.setFlashMode(isEnable ? Camera.Parameters.FLASH_MODE_TORCH : Camera.Parameters.FLASH_MODE_OFF);
    ...
    public void setCameraParameters(SurfaceHolder holder){
        if(camera == null){
            return;
        }
        camera.stopPreview();
